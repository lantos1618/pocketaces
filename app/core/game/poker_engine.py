...
from ...models.game_models import (
    GameState, Player, PlayerAction, ActionType, GamePhase, Card, HandRank, PlayerStatus
)
...
class PokerEngine:
    ...
    def evaluate_hand(self, hole_cards: List[Card], community_cards: List[Card]) -> HandRank:
    ...
    def start_new_game(self, room_id: str) -> Optional[GameState]:
        ...
        game = game_store.create_game(room_id)
        if not game:
            return None
    ...
    def _determine_winner(self, game: GameState) -> None:
        ...
        winners = [player for player, hand in player_hands if hand.value == best_hand_value]
