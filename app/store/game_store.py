...
import asyncio
from ..models.game_models import GameRoom, GameState, Player, GameEvent, GameResult, HandRank
...
class GameStore:
    ...
    def get_relevant_memories(self, agent_id: str, opponent_id: str, limit: int = 5) -> List[AgentMemory]:
    ...
    def get_room_stats(self, room_id: str) -> Optional[RoomStats]:
        ...
        most_active = max(player_games.items(), key=lambda x: x[1])[0] if player_games else None
